...
/** End of old RTC config block **/
    ...
    INT_SETTING_NOWRAP(F_SOUNDSETTING, lofi_bitdepth,
                       LANG_LOFI_BITDEPTH, 16,
                       "lofi bit depth", UNIT_INT, 4, 16, 1,
                       NULL, NULL, dsp_set_lofi_bitdepth),
    INT_SETTING_NOWRAP(F_SOUNDSETTING, lofi_downsample,
                       LANG_LOFI_DOWNSAMPLE, 1,
                       "lofi downsample", UNIT_INT, 1, 16, 1,
                       NULL, NULL, dsp_set_lofi_downsample),
    INT_SETTING_NOWRAP(F_SOUNDSETTING, vinyl_crackle,
                       LANG_VINYL_CRACKLE, 0,
                       "vinyl crackle", UNIT_INT, 0, 100, 1,
                       NULL, NULL, dsp_set_vinyl_crackle),
    INT_SETTING_NOWRAP(F_SOUNDSETTING, vinyl_compression,
                       LANG_VINYL_COMPRESSION, 0,
                       "vinyl compression", UNIT_INT, 0, 100, 1,
                       NULL, NULL, dsp_set_vinyl_compression),
    INT_SETTING_NOWRAP(F_SOUNDSETTING, vinyl_flutter,
                       LANG_VINYL_FLUTTER, 0,
                       "vinyl flutter", UNIT_INT, 0, 100, 1,
                       NULL, NULL, dsp_set_vinyl_flutter),
    CHOICE_SETTING(F_SOUNDSETTING, vinyl_mode, LANG_VINYL_MODE, 0, "vinyl mode",
                   "vinyl,tape", dsp_set_vinyl_mode, 2,
                   ID2P(LANG_VINYL_MODE_VINYL), ID2P(LANG_VINYL_MODE_TAPE)),
    /* equalizer */
